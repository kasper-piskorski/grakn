...
public class InferenceRule {
     ...
     */
    public ResolutionState subGoal(Atom parentAtom, Unifier ruleUnifier, QueryStateBase parent, Set<ReasonerAtomicQuery> visitedSubGoals, QueryCacheImpl<ReasonerAtomicQuery> cache){
