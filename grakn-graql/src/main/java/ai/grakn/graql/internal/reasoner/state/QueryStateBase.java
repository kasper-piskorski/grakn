...
public abstract class QueryStateBase extends ResolutionState {
    ...
    QueryStateBase(Answer sub, Unifier u, QueryStateBase parent, Set<ReasonerAtomicQuery> subGoals, QueryCacheImpl<ReasonerAtomicQuery> cache) {
        super(sub, parent);
        this.unifier = u;
     ...
     * @return query cache
     */
    QueryCacheImpl<ReasonerAtomicQuery> getCache(){ return cache;}
