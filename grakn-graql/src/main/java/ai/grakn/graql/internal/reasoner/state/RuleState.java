...
public class RuleState extends QueryStateBase{
    ...
    public RuleState(InferenceRule rule, Answer sub, Unifier unifier, QueryStateBase parent, Set<ReasonerAtomicQuery> visitedSubGoals, QueryCacheImpl<ReasonerAtomicQuery> cache) {
